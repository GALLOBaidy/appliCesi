...
exports.feelingsStats = exports.runsByDay = exports.totalRuns = exports.totalUsers = void 0;
const svc = __importStar(require("../services/stats.service"));
...
exports.totalRuns = totalRuns;
const runsByDay = async (req, res) => {
    const rows = await svc.getRunsByDay();
    res.json(rows);
};
exports.runsByDay = runsByDay;
const feelingsStats = async (req, res) => {
    const rows = await svc.getFeelingsStats();
    res.json(rows);
};
exports.feelingsStats = feelingsStats;
